...
function on_stop(message)
    print("Bot's script is stopped due to "..message)
    GonWebhook("Script Berhenti ("..bot.name..") ".."<@" .. YourDiscordid .. ">")
end
...
function Dropf(list)
    ...
    if inventory:getItemCount(BlockID+1) >= 100 then
        ...
        "\n <:world:1240859738309394493> Current World : "..world.name..
...
while isOwner == true do
    for _, list in pairs(farmWorlds) do
        ...
        "\n <:fossil:1240860750298218527> Fossil : "..tarama(3918).miktr..
